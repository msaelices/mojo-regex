...
fn main() raises:
    ...
    if complexity.value == PatternComplexity.SIMPLE:
        ...
        print("✓ IMPROVEMENT: Pattern classified as MEDIUM (hybrid approach)")
    else:
        print("✗ Still classified as COMPLEX (using slow NFA)")

    # Also test the optimization analysis
    ...
    print("Engine type:", regex.get_stats())
